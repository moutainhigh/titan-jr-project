    ...
    <div class="enterprise personal-bank-infor isShow">
        ...
        <div class="content enterprise-content clearfix">
            ...
            <div class="enterprise-form clearfix" style="margin-bottom: 30px">
                <div id="limitTitle" class="left fl isShow" style="line-height: 34px">付款限额</div>
                <div class="right fl">
...
<div class="payment-verification isShow">
    ...
    <div class="payment-verification-content">
        ...
        <div class="phone message clearfix">
            ...
            <div class="right fl"><input type="text" placeholder="请输入验证码" onkeyup="value=value.replace(/[^\d]/g,'')"/><i class="iconfont icon-sc forgot-password-empty isShow"></i><button class="obtain-btn obtain-btn-1">获取验证码</button></div>
