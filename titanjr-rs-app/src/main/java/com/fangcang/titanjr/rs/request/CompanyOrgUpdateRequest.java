...
/**
 * Created by zhaoshan on 2016/4/11.
 */
public class CompanyOrgUpdateRequest extends BaseRequest {
    //===============以下信息必填==========
    //企业名称
    ...
    public void check() throws RSValidateException {
        ...
        RequestValidationUtil.checkNotEmpty(this.opertype,"opertype");
        ...
        RequestValidationUtil.checkMaxLength(this.opertype, 1, "opertype");
