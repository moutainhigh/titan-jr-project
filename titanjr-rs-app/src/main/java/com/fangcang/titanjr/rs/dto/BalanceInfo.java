...
public class BalanceInfo {
    ...
    public String toString() {
        return new ToStringBuilder(this)
                .append("pulsedegree", pulsedegree)
                .append("balanceusable", balanceusable)
                .append("balancecredit", balancecredit)
                .append("balancesettle", balancesettle)
                .append("pulsetime", pulsetime)
                .append("balancefrozon", balancefrozon)
                .append("finaccountid", finaccountid)
                .append("balanceoverlimit", balanceoverlimit)
