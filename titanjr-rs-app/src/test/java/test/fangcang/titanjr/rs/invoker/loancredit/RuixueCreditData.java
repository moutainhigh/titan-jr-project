...
public class RuixueCreditData {
    ...
    private String contributionAmount;//出资金额（万元）
    private String equityRatio;//股权比例
    ...
    private String mainProductsOrService;//主要产品或服务
    private String mainAnnualSale;//主要产品或服务年销售规模（万元）
    private String mainSaleProportion;//主要产品或服务占总销售额比例
    private String buyerName;//买家名称
    private String buyerAnnualSale;//买家年销售规模（万元）
    private String buyerSaleProportion;//买家占总销售额比例
    private String buyerSettlement;//买家结算方式
    private String buyerCooperationYears;//买家合作年限
    private String sellerName;//卖家名称
    private String sellerAnnualSale;//卖家年销售规模（万元）
    private String sellerSaleProportion;//卖家占总销售额比例
    private String sellerSettlement;//卖家结算方式
    private String sellerCooperationYears;//卖家合作年限
