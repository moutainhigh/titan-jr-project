		...
		<div class="r_c ">
			<div class="r_text">
				<ul>
					...
					<li class="r_y1"><div class="rt_title">联系人</div><input type="text" class="text" name="connect" value="${orgSubDTO.connect }" datatype="*" errormsg="必填项" placeholder="请输入联系人" ></li>
					<li class="r_y1"><div class="rt_title">联系手机</div><input type="text" class="text" name="mobiletel" value="${orgSubDTO.mobileTel }" id="mobiletel" require="true" datatype="m" errormsg="格式不正确" placeholder="请输入联系手机"></li>
