 ...
 */
public class TitanOrderRequest {
	...
	private String userId;// 付款方身份标示 如果是财务，则建议是FCUSERID， 如果是GDP，则是用户ID
	private String ruserId;// 收款方身份标示 N ,GDP可以指定接受方的 商家联盟可以指定其FCUSERID
