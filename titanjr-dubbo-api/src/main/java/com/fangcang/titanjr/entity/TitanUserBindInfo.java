...
/**
 * TitanUserBindInfo entity. @author MyEclipse Persistence Tools
 */

public class TitanUserBindInfo implements java.io.Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5101571351463771666L;
	// Fields
