...
public class TitanOrderPayreq  implements java.io.Serializable {
    ...
    /** full constructor */
    public TitanOrderPayreq(Integer transorderid, String merchantNo, String orderNo, String productNo, String productName, String productDesc, Integer productNum, Double orderAmount, String payType, String amtType, String bankInfo, String payerAcount, String payerName, String payerPhone, String payerMail, String pageUrl, String notifyUrl, String orderTime, Integer orderExpireTime, Integer orderMark, String expand, String expand2, Integer signType, String busiCode, String version, Integer charset, String signMsg, Integer reqstatus, Float standardrate, Float executionrate, Integer ratetype, Float receivablefee, Float receivedfee) {
