...
//		final StringBuffer result = new StringBuffer();
	...
	public static String formatFileSize(long size)
	{
		if (size > 0 && size < 1024) {
			...
			return RsaStringUtils.double2Str((double)size/1024) + " KB";
		} else if (size >= 1024 * 1024) {
			return RsaStringUtils.double2Str((double)size/1024/1024) + " MB";
		} else {
			return "0 B";
		}
	}
...
*/
	...
	public static String strMulti2Parameter(String para){
		...
		ArrayList array = RsaStringUtils.strSplit(";",para);
