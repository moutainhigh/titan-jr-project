package com.fangcang.titanjr.web;

import java.util.regex.Pattern;
/**
 * Created by zhaoshan on 2017/8/21.
 */
public class RegexValidator {

    public static void main(String[] args) {
        System.out.println(RegexValidator.isPhone("14720371215"));
        System.out.println(RegexValidator.isEmail("21312@123.com"));
    }
