...
public class FinancialMainController extends BaseController {
    ...
    public String home(HttpServletRequest request, Model model) throws Exception {
    	Integer isAdmin = (Integer)session.getAttribute(CommonConstant.SESSION_KEY_LOGIN_IS_ADMIN);
    	String jrUserLoginName = (String)session.getAttribute(CommonConstant.SESSION_KEY_JR_LOGIN_UESRNAME);
    	//暂时统一从session中取
    	String orgBindStatus = (String)session.getAttribute(CommonConstant.SESSION_KEY_JR_BIND_STATUS);
