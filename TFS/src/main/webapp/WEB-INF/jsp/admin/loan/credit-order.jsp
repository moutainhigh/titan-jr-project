...
<meta charset="utf-8">
  ...
  <div class="my_acount" >
		...
		<div class="acount" style="min-height:400px;">
			<div class="table_top">
				<div class="fr">
					...
					<div class="selecttit fl">
						...
						<div class="selectcon">
							...
							<p data-value="10">提交中</p>
							<p data-value="11">提交失败</p>
							<p data-value="3">复审中</p>
  ...
  function commit(orderNo){
	  var d = top.dialog({
	        ...
	        ok: function () {
	        	top.F.loading.show();
	      	  $.ajax({
	      		  url:"<%=basePath%>/admin/check-commit-info.shtml",
	      		  type:"post",
	      		  dataType:"json",
