	...
	<div class="examine">
		<div class="examine_left fl">
			<div class="examinele_con">
				...
				<ul>
					<li class="fs16">公司名称：<span class="orange">${financialOrganDTO.orgName }</span></li>
					<li class="fs16">营业执照号：<span class="orange">${financialOrganDTO.buslince }</span></li>
		...
		<c:if test="${opt=='check' }">
			...
			<div class="examine_righttop">
				...
				<p class="ptb9"><span class="w80"><i class="c_fc2020">*</i>审核结果：</span>
					<select id="checkStatus" class="w100 select w135 J_nothroght">
				...
				<p class="ptb9 showhide"><span class="w80"><i class="c_fc2020">*</i>未通过原因：</span>
					<textarea id="checkReason" class="textarea" placeholder="请输入未通过原因。"></textarea>
				</p>	
			</div>	
