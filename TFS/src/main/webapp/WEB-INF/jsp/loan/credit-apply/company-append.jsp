        ...
        <div class="loanInformation">
                ...
                <table cellspacing="0" cellspacing="0" width="100%" class="loanInformation_tab">
                    ...
                    <tr fieldObj='controllDatas' >
                        ...
                        <td class="loanInformation_td02">
                            <input type="text" class="loanInformation_inp01" placeholder="请输入股东名称" field='shareholderName'>
                        </td>
                        <td class="loanInformation_td01">
                             <i class="redNotice">*</i>出资金额：
                        </td>
                        <td class="loanInformation_td03">
                           <input type="text" class="loanInformation_inp02" placeholder=""  field='contributionAmount'> 万元
                        </td>
                        <td class="loanInformation_td01">
                             <i class="redNotice">*</i>出资金额：
                        </td>
                        <td class="loanInformation_td03">
                           <input type="text" class="loanInformation_inp02" placeholder="" field='equityRatio'> %
            ...
            <table cellspacing="0" cellspacing="0" width="100%" class="loanInformation_tab">
                ...
                <tr fieldObj="mainBusinessDatas">
                    ...
                    <td class="loanInformation_td02">
                        <input type="text" class="loanInformation_inp01" placeholder="请输入主要产品/服务" field="mainProductsOrService">
                    </td>
                    <td class="loanInformation_td01">
                         <i class="redNotice">*</i>年销售规模：
                    </td>
                    <td class="loanInformation_td03">
                       <input type="text" class="loanInformation_inp02" placeholder="" field="mainAnnualSale"> 万元
                    </td>
                    <td class="loanInformation_td01">
                         <i class="redNotice">*</i>占总销售额比例：
                    </td>
                    <td class="loanInformation_td03">
                       <input type="text" class="loanInformation_inp02" placeholder="" field="mainSaleProportion"> %
                       <span class="J_deleteBtnTFS blue">删除</span>
                    </td>
                </tr>            
            </table>
            ...
            <table cellspacing="0" cellspacing="0" width="100%" class="loanInformation_tab loanInformation_tab1" >
                ...
                <tr>
                    ...
                    <td class="loanInformation_td02">
                        <input type="text" class="loanInformation_inp01" placeholder="请输入合作企业名称" field='cooperationName'>
                    </td>
                    <td class="loanInformation_td01">
                         <i class="redNotice">*</i>年销售规模：
                    </td>
                    <td class="loanInformation_td03">
                       <input type="text" class="loanInformation_inp02" placeholder="" field='yearAnnualSale'> 万元
                    </td>
                    <td class="loanInformation_td01">
                         <i class="redNotice">*</i>占总销售额比例：
                    </td>
                    <td class="loanInformation_td03">
                       <input type="text" class="loanInformation_inp02" placeholder="" field='saleProportion'> %
                    </td>
                </tr>     
                <tr>
                    <td class="loanInformation_td01">
                    ...
                    <td class="loanInformation_td02">
                        <input type="text" class="loanInformation_inp01" placeholder="请输入结算方式" field='settlement'>
                    </td>
                    <td class="loanInformation_td01">
                         <i class="redNotice">*</i>年销售规模：
                    </td>
                    <td class="loanInformation_td03">
                       <input type="text" class="loanInformation_inp02" placeholder="" field='cooperationYears'> 年&nbsp;&nbsp;&nbsp;
                    </td>
                    <td class="loanInformation_td01">
                         <i class="redNotice">*</i>合作关系：
                    </td>
                    <td class="loanInformation_td03">
                       <select class="select loanInformation_se02" field='cooperation'>
                            <option>请选择</option>
                ...
                <tr class="dnTypeTms">
                    ...
                    <td class="loanInformation_td02">
                        <span id="dateSelectorAppend" fields='beginLeaseDate' split='-'>
                            <select id="idYearAppend" name="idYearAppend" class="select loanInformation_se01" data="" item="year"></select>
                           <select class="select loanInformation_se01" id="idMonthAppend" name="idMonthAppend" data="12" item="month"></select>
                        </span>
                         <span class="loanInformation_td02_ico">——</span>
                         <span id="dateSelector1Append"  fields='endLeaseDate' split='-'>
                            <select id="idYear1Append" name="idYear1Append" class="select loanInformation_se01" data="" item='year'></select>
                            <select class="select loanInformation_se01" id="idMonth1Append" name="idMonth1Append" data="12" item='month'></select>
                        </span>
                    </td>   
                    <td class="loanInformation_td01">
                    ...
                    <td class="loanInformation_td03" colspan="3">
                        <input type="text" class="loanInformation_inp02 loanInformation_inp05" placeholder="" field='housingArea'> 平方米
                    </td>                 
                </tr>
                <tr class="dnTypeTms">
                    <td class="loanInformation_td01">
                    ...
                    <td class="loanInformation_td03">
                       <input type="text" class="loanInformation_inp02 loanInformation_inp06" placeholder="" field='rental'> 万/年
                    </td>   
                    <td class="loanInformation_td01">
                        <i class="redNotice">*</i>支付方式：
                    </td>
                    <td class="loanInformation_td03" colspan="3">
                        <input type="text" class="loanInformation_inp01" placeholder="请输入支付方式"  field='paymentMethod'> 
                    </td>                 
                </tr>
                <tr class="dnTypeTms">
                    <td class="loanInformation_td01">
