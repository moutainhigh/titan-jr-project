	            ...
	            <div class="clearfix basic">
	                 <div class="basic_c personage">
	                   ...
	                   <div class="b_c_c clearfix brn">
	                    <ul>
	                    <li style="padding-bottom:30px;"><p><i class="c_f00">*</i>姓名：</p><input type="text" class="text w_500 " name="orgName" id="orgName" value="${orgSubDTO.orgName }" placeholder="请与证件上的姓名保持一致"  datatype="*" errormsg="姓名不能为空"></li>
	                       <li style="padding-bottom:30px;"><p><i class="c_f00">*</i>身份证号：</p><input type="text" class="text w_500 " name="certificatenumber" id="certificatenumber" value="${orgSubDTO.certificateNumber }" datatype="*" errormsg="身份证号不能为空" afterPassed="checkOrgRegNum"></li>
	                       <li>
	                        <div class="fl w_370">
